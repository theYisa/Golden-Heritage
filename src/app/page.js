        ...
        <div className='heroContent'>
          ...
          <div className='heroButtons'>
            <a href="#enquiry" className='btnPrimary'>
              Secure Admission <ArrowRight size={16} />
            </a>
      ...
      <section id="programs" className='programsSection'>
        ...
        <div className='programsGrid'>
          {[
            ...
            { title: 'Primary School', desc: 'Building strong foundations in literacy, numeracy, and foundational sciences using interactive methods.', icon: <BookOpen size={22} /> },
            { title: 'Grade 7-9 (Junior Secondary)', desc: 'Transitioning students into deep critical thinking, scientific exploration, and rigorous language studies.', icon: <GraduationCap size={22} /> },
            { title: 'WAEC Tracks (Grade 10-12)', desc: 'New launching upper secondary block preparing students effectively for the West African Senior School Certificate.', icon: <Shield size={22} /> },
            { title: 'Language Institute', desc: 'Specialized intensive programs in English and Portuguese, tailored specifically for students and adult professionals.', icon: <Languages size={22} /> },
            ...
            <div key={idx} className='programCard'>
