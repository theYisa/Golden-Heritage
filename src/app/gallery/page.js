...
export default function GalleryPage() {
  ...
  const fotosGaleria = [
    ...
    { id: 3, src: "/art (3).jpg", title: "STEM Experimental Lab", caption: "Igniting curiosity through practical science." },
    ...
    { id: 6, src: "/art (6).jpg", title: "Infant Care Pavilion", caption: "Serene, medically hygienic crèche framework." },
    { id: 7, src: "/art (7).jpg", title: "Primary Graduation", caption: "Celebrating our academic heavyweights." },
    { id: 8, src: "/art (8).jpg", title: "Resource Discovery Center", caption: "Deepening literature and analytical habits." },
    { id: 9, src: "/art (9).jpg", title: "Creative Arts Showcase", caption: "Exploring individual musical brilliance." },
    { id: 10, src: "/art (10).jpg", title: "Digital Literacy Suite", caption: "Mastering quantitative computer tools." }
  ];
      ...
      <section className="sectionWrapper lightGreyBg">
        <div className="sectionGrid centralMax proprietorAlign">
          <div className="proprietorImgArea">
            <img src="/sir.jpg" alt="School Proprietor" className="proprietorPhoto" />
